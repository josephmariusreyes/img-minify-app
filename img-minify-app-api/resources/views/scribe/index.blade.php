...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-optimizeImage">POST api/optimizeImage</h2>
...
<span id="example-requests-POSTapi-optimizeImage">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-POSTapi-optimizeImage" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-optimizeImage"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-optimizeImage" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-optimizeImage">
...
<form id="form-POSTapi-optimizeImage" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-optimizeImage"
                    onclick="tryItOut('POSTapi-optimizeImage');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-optimizeImage"
                    onclick="cancelTryOut('POSTapi-optimizeImage');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-optimizeImage"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <b><code>api/optimizeImage</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-optimizeImage"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="files[0]"                data-endpoint="POSTapi-optimizeImage"
               data-component="body">
        <input type="file" style="display: none"
